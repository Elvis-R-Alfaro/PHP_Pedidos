            ...
            <div class="col-md-8">
              ...
              <div class="card">
                    ...
                    <table class="table m-0">
                      ...
                      <?php foreach ($this->datos as $row) { ?>
                        <tr>
                          ...
                          <td><a href="/cargos/eliminar?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-danger" >Eliminar</button></a></td>
                        </tr>
                        <?php  } ?>
                      </tbody>
                    </table>
                ...
                <div class="card-footer clearfix">
                  <a href="/cargos/nuevo" class="btn btn-sm btn-info float-left">Generar nuevo cargo</a>
