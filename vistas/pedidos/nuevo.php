                ...
                <div class="card-body">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="idmesero" name="idmesero" placeholder="Id mesero">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="Estacion">Estacion</label>
                            <input type="text" class="form-control" id="Estacion" name="Estacion" placeholder="Estacion">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="activo">Activo</label>
                            <input type="text" class="form-control" id="activo" name="activo" placeholder="Activo">
                        </div>
                        <div class="form-group col-md-6">
