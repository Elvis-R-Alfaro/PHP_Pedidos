                ...
                <div class="card-body">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="NumeroFactura" name="NumeroFactura" placeholder="Numero Factura" value="<?php echo $this->datos[0]['NumeroFactura'] ?>">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="NumeroPedido">Numero pedido</label>
                            <input type="text" class="form-control" id="NumeroPedido" name="NumeroPedido" placeholder="Numero Pedido" value="<?php echo $this->datos[0]['NumeroPedido'] ?>">
                        </div>
                    </div>             
                <!-- /.card-body -->
